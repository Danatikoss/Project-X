...
function TopNavLink({ to, icon: Icon, label }: { to: string; icon: React.ElementType; label: string }) {
  return (
    <NavLink
      to={to}
      className={({ isActive }) =>
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <ChevronDown className={cn('w-3 h-3 text-gray-400 transition-transform hidden lg:block', open && 'rotate-180')} />
      </button>
