...
export function SlidePreviewModal({
	...
	}, [currentIdx, showLabelInput, showFolderPicker, slides, hasPrev, onNavigate, onClose, hasNext]);
						...
						<div className="flex items-center gap-2 mt-1 flex-wrap">
							...
							{slide.created_at && (
								<span className="text-xs text-gray-400">
									Добавлен: {formatDate(slide.created_at)}
								</span>
							)}
							...
							<div className="relative">
								...
								>
									{currentProject ? (
										...
										<>
											<FolderSymlink className="w-3 h-3" />В папку
										</>
									)}
								</button>
				...
				<div className="relative bg-gray-50">
					...
					{onStartSlideshow && slides && slides.length > 1 && (
						<button
							onClick={() => {
								onClose();
								onStartSlideshow(currentIdx >= 0 ? currentIdx : 0);
							}}
