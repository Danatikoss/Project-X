  ...
  return (
    <div className="max-w-xl mx-auto px-6 py-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        <div className="w-14 h-14 rounded-2xl bg-gradient-brand flex items-center justify-center shadow-md shrink-0">
          <span className="text-white text-xl font-bold">{initials}</span>
        </div>
        <div>
          <h1 className="text-xl font-bold text-slate-900">{profile?.name || authUser?.name || 'Профиль'}</h1>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 mb-4 shadow-card">
        ...
        <div className="flex flex-col gap-4">
          <div>
            <label className="block text-xs font-semibold text-slate-600 mb-1.5 uppercase tracking-wide">Имя</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-600 mb-1.5 uppercase tracking-wide">Организация</label>
            <input
              type="text"
              value={company}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 bg-gradient-brand text-white rounded-xl text-sm font-semibold hover:opacity-90 disabled:opacity-50 transition-all shadow-sm"
          >
      ...
      <div className="mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 border border-slate-200 bg-white text-slate-600 rounded-xl text-sm font-medium hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-all shadow-card"
        >
